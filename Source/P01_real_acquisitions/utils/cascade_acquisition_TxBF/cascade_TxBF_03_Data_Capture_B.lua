...
capture_time                     =   11000                            -- ms
inter_loop_time                  =   2000                             -- ms
break_time 						 =   1000						     -- ms
num_loops                        =   3
total_loop_time					 =	 15000    					     -- ms
...
acq_mode 						=	"Cascade_TxBF_B77"
acq_desc						=	"ETH_Studierendenwohnheim_30deg"--"ETH_Studierendenwohnheim"--"ETH_Buildings"			
capture_directory 				=   string.format("%s_%s_%s_%08dms",acq_mode,acq_desc,acq_start,total_loop_time)

num_frames_to_capture           =   1000                    -- 0: default case; Any positive value - number of frames to capture 
